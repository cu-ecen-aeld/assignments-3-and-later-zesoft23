...
{
    const char * my_username_pointer = my_username();
    char * my_username_conf_file = malloc_username_from_conf_file();
    TEST_ASSERT_EQUAL_STRING_MESSAGE(my_username_pointer, my_username_conf_file, "pass");
}
